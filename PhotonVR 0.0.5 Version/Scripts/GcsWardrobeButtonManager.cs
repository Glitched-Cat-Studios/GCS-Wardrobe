...
namespace GlitchedCatStudios.Wardrobe
{
    public class GcsWardrobeButtonManager : MonoBehaviour
    {
        ...
        internal void UpdateButtonColor()
        {
            ...
            {
                UpdateEquipButtonColor(GcsWardrobeManager.instance.slot1.GetComponent<GcsWardrobeInfo>());
            }
            else if (type == GcsWardrobeButtonType.MiddleEquip)
            {
                UpdateEquipButtonColor(GcsWardrobeManager.instance.slot2.GetComponent<GcsWardrobeInfo>());
            }
            else if (type == GcsWardrobeButtonType.RightEquip)
            {
                UpdateEquipButtonColor(GcsWardrobeManager.instance.slot3.GetComponent<GcsWardrobeInfo>());
            }
        }

        private void UpdateEquipButtonColor(GcsWardrobeInfo info)
        {
            GcsWardrobeCosmeticType type = info.type;
